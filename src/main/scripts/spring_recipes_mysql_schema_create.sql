# schema to create database, generated by Hibernate
create table category (id bigint not null auto_increment, description varchar(255), primary key (id)) engine=InnoDB;
create table ingredient (id bigint not null auto_increment, description varchar(255), quantity decimal(19,2), recipe_id bigint, unit_of_measure_id bigint, primary key (id)) engine=InnoDB;
